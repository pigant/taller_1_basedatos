 ...
 * @author ignacio
 */
public class JPBuscarVenta extends javax.swing.JPanel {

	/**
	 * Creates new form JPVerVenta
	 */
	public JPBuscarVenta() {
		initComponents();
	}
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
		...
		try {
			venta = VentaBuilder.getVenta(codigo);
			...
			JOptionPane.showMessageDialog(this,
					"La compra especificada no existe",
					"No existe compra", JOptionPane.ERROR_MESSAGE);
			jL_total.setText("0");
		}
